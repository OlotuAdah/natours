...
const sendErrProd = (err, res) => {
  if (err.isOperationalError) {
    //Only error created explicitly by AppError class will return true for this
    return res
...
const handDuplicateEmailError = (error) => {
  new AppError('A user already exists with this email!', 401);
};
